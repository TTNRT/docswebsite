...
## Information
When you request to have your password reset, you have to make sure you have it changed to a more secure one that you can remember. Creating password should be at least 6 to 8 characters long or more, along with having a symbol, or number in it. If available, you can use a password generator tool that you can find online or if your password manager has one available for you.
