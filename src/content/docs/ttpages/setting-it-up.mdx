...
1. Create your repo by using one of the methods above. The repo should also have a `pages` branch, along with the `pages` topic applied to it.
...
5. Your site should work when you use the URL that is stated in the [Additional information](#additonal-information) section!
