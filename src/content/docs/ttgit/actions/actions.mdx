...
3. A repository of your chossing
...
2. Once you have it downloaded, move the application to any location of your chossing. In this case, we will move it to the `C:\` drive.
...
If you wanted to, you can use the command below to register the runner using it's agruements to make the proccess a bit easier to do.
