...
### Quick start method
If you want to get started on deploying the source code without having to do anything that requires the Wrangler CLI, click on the image button below to deploy the source code directly to the Cloudflare Workers platform!
...
When you do this, it will open your default browser and will ask you to authorize it with your existing Cloudflare account. If you are not already logged in with it, make sure that you do that before running the command!
